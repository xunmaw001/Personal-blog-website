...
import center from '@/views/center'
    import xiangcefenxiang from '@/views/modules/xiangcefenxiang/list'
    import discussxiangcefenxiang from '@/views/modules/discussxiangcefenxiang/list'
...
const routes = [{
    ...
    children: [{
      ...
      ,{
	path: '/xiangcefenxiang',
        name: '相册分享',
        component: xiangcefenxiang
      }
      ,{
	path: '/discussxiangcefenxiang',
        name: '相册分享评论',
        component: discussxiangcefenxiang
      }
      ,{
	path: '/yonghu',
        name: '用户',
